...
# Returns a list of timestamps, corresponding to the middle of every "blank segment", where no speech is detected
...
# Finds the segments where no speech is detected to cut there, instead of in the middle of words...
# Note : Arbitrary choice of "amplitude < '100'", might not work with all audio files...
# TODO : Make a parameter for that threshold ...?
...
# Split audio based on input segment_length parameter and possible cuts.
# Saves all the parts on disk...
# TODO : Might not work if no possible cuts where found... !
...
# Dirty function to artificially 'extend' the duration of detected 'speech segments'... A filter might be more appropriate.. (Not used anyway...)
...
# Trying to amplify audio when multiple speakers. Turns out shit yield poorer results : not used after all...
